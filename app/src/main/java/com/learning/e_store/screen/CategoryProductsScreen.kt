...
@Composable
fun CategoryProductsScreenRoute(
        ...
        if (uiState.isLoading) {
            ...
            LazyVerticalGrid(
                ...
                itemsIndexed(uiState.products){ index, product ->
                    ...
                    CategoryProductItem(product = product, onClick = { onProductClick(product.productId) })
...
@Composable
fun CategoryProductItem(product: Product, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .padding(8.dp)
